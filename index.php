    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-primary relative">
            ...
            <div class="relative w-full flex items-center justify-center px-12">
                <div class="max-w-lg">
                    <h1 class="text-4xl font-bold text-white mb-6">Welcome to InternLog</h1>
                    <p class="text-lg text-primary-foreground/90">Document your internship journey, track your progress,
                        and share your experiences with supervisors.</p>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-md w-full">
                ...
                <form method="POST" action="" class="space-y-6">
                    ...
                    <p class="text-center text-sm text-muted-foreground">
                        Don't have an account? <a href="register.php" class="text-primary hover:underline">Register
                            here</a>
                    </p>
                </form>
            </div>
